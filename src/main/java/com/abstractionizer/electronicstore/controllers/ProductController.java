...
public class ProductController {
    ...
    public SuccessResp<BasketVo> putProductIntoBasket(@PathVariable Integer productId,
    ...
    public SuccessResp<BasketVo> removeAProductFromBasket(@PathVariable Integer productId,
